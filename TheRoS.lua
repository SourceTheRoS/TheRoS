...
return {
Lock     = '[TheRoS](https://t.me/ZJJJE)\n*— — — — — — — — —\n᥀︙بواسطه ›› *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[TheRoS](https://t.me/ZJJJE)\n*— — — — — — — — —\n᥀︙بواسطه ›› *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[TheRoS](https://t.me/ZJJJE)\n*— — — — — — — — —\n᥀︙بواسطه ›› *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[TheRoS](https://t.me/ZJJJE)\n*— — — — — — — — —\n᥀︙بواسطه ›› *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[TheRoS](https://t.me/ZJJJE)\n*— — — — — — — — —\n᥀︙بواسطه ›› *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[TheRoS](https://t.me/ZJJJE)\n*— — — — — — — — —\n᥀︙المستخدم ›› *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = 'TheRoS ⁦', url='https://t.me/ZJJJE'},
},
}
}
...
if text == 'ايديي' or text=='منو اني' then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/ZJJJE'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
keyboardd.inline_keyboard = {
{
{text = '- 𝘛𝘩𝘌𝘳𝘖𝘴', url = "https://t.me/ZJJJE"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{
{text = 'Communication Source', url = 't.me/N3Ybot'}, 
},
{
{text = 'Developer Source !', url = 't.me/vOvvvvv'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
data = {
{
{text = '-𝘛𝘩𝘌𝘳𝘖𝘴 𝘚𝘰𝘜𝘳𝘊𝘦 .', url = 't.me/ZJJJE'},
},
{
