...
if text == (Redis:get(TheTheRoS.."TheRoS:Name:Bot") or "ريتا") then
local NamesBot = (Redis:get(TheTheRoS.."TheRoS:Name:Bot") or "ريتا")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheTheRoS.."TheRoS:Name:Bot") or "ريتا")..
